  ...
  return (
    <div className="p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-serif mb-1 text-deep-ink">Patients</h1>
          <p className="text-slate text-sm">Manage and review your patient registry</p>
        </div>
      ...
      <Card className="p-2 px-4 flex items-center gap-3">
        ...
        <input
          ...
          className="w-full py-2 text-deep-ink placeholder-slate focus:outline-none bg-transparent text-sm"
        />
        {searchTerm && (
          <button
      ...
      <div className="flex gap-3 flex-wrap">
        ...
        <Badge variant="success" className="px-4 py-1.5 text-xs font-medium">

...
- **CloudWatch** _(optional)_: Application log group with configurable retention.

_For advanced options (such as cross-region S3 replication or CloudWatch alerts), refer to [`terraform/README.md`](../terraform/README.md)._
...
| `AWS_SESSION_TOKEN`            | No       | _(temporary STS)_            | Optional temporary session token                    |

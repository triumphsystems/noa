...
export class WebMCPRegistry {
  ...
  private resources = new Map<
    string,
    { definition: ResourceDefinition; reader: ResourceReader }
  >();
  private resourceTemplates: Array<{
  ...
  private prompts = new Map<
    string,
    { definition: PromptDefinition; generator: PromptGenerator }
  >();
  ...
  public registerResourceTemplate(
    ...
    const pattern = template.uriTemplate.replace(
      /\{([a-zA-Z0-9_]+)\}/g,
      (_, paramName) => {
